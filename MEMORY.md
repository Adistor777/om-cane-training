...
behaviour). Load order: activities.js → supabase.js (vendored UMD, on
`feat/cloud-sync`) → store.js → app.js.
...
- **CODE WIRING DONE 2026-07-06 pm (`feat/cloud-sync`, commits `9b0a7a0` +
  `d68f429`, UNMERGED, flag OFF → offline pilot byte-identical, tests 35/35):**
